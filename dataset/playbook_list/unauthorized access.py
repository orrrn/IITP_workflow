# This is unauthorized access incident playbook
# In STATE OF ALABAMA
# Written in Sudocode
...
def containment_Eradication_and_recovery():
    goto Perform_an_initial_containment_of_the_incident
    goto Acquire,_preserve,_secure,_and_document_evidence
    goto Confirm_containment_of_the_Incident
    goto Further_analyze_the_incident_and_determine_if_containment_was_sufficient
    goto Check_other_systems_for_signs_of_intrusion
    goto Implement_additional_containment_measures_if_necessary
    goto Eradicate_the_incident
    goto Identify_and_mitigate_all_vulnerabilities_that_were_exploited
    goto Remove_components_of_the_incident_from_systems
    ...
    goto If_necessary,_implement_additional_monitoring_to_look_for_future_related_activity
