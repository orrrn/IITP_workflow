# This is malicious code incident playbook
# In STATE OF ALABAMA
# Written in Sudocode
...
def containment_Eradication_and_recovery():
    ...
    goto Identify_infected_systems
    goto Disconnect_infected_systems_from_the_network
    goto Mitigate_vulnerabilities_that_were_exploited_by_the_malicious_code
    goto If_necessary_block_the_transmission_mechanisms_for_the_malicious_code
    goto Eradicate_the_incident
    goto Disinfect_quarantine_delete_and_replace_infected_files
    goto Mitigate_the_exploited_vulnerabilities_for_other_hosts_within_the_organization
    ...
    goto If_necessary_implement_additional_monitoring_to_look_for_future_related_activity
