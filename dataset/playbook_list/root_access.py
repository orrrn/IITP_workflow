# Root Access in Incident Response Playbook from Incident Response Consortium
# Written in Sudocode
...
def detect():
    if define_threat_indicators is is_custom:
        ...
        goto increased_administrator_or_root_logins_to_a_computer_systems
        goto administrative_or_root_access_to_systems_outside_of_normal_business_hours
        ...
        goto installation_or_configuration_of_unauthorized_software_or_services
...
def analyze():
    if define_risk_factors is is_custom:
        ...
        goto employees_are_affected_by_this_compromise
...
def contain():
    ...
    goto identify_systems_locked_out_due_to_repeated_login_attemps(servers, desktop, laptop, mobile, VM, LDAP_directory)
