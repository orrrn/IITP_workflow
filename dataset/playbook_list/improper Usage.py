# This is Improper Usage incident playbook
# In STATE OF ALABAMA
# Written in Sudocode
...
def containment_Eradication_and_recovery():
    ...
    goto Assess_the_incident
    goto Determine_whether_the_activity_seems_criminal_in_nature_and_if_necessary_notify_law_enforcement
    goto Discuss_incident_indicators_and_possible_actions_with_human_resources_personnel
    goto Discuss_liability_issues_with_legal_counsel
    goto Keep_the_investigative_team_small_and_maintain_strict_confidentiality
    goto If_necessary_contain_and_eradicate_the_incident
    goto Recover_from_the_incident
    goto Return_affected_systems_to_an_operationally_ready_state
    goto Destroy_investigative_materials_when_directed_by_legal_counsel_or_law_enforcement
